                ...
                {messages.length === 0 && (
                    <div className="flex min-h-[22rem] flex-col items-center justify-center text-center">
                      ...
                      <div className="mt-5 rounded-2xl bg-brand-bg px-4 py-3 text-left text-xs text-brand-muted">
                        ...
                        &ldquo;I&apos;d like to see a dentist
                        next Tuesday at 2pm.&rdquo;
                      </div>
                    </div>
                )}
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-brand-muted">
                      ...
                      technology is used for speaking and
                      listening. If your selected language
                      does not have a supported voice, the
                      response will appear as text.
                    </p>
                  </div>
                </div>
              </div>
